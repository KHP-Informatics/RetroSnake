...
##    print (line)
    ...
    os.system("python %s/testForHervPresence.py %s/repeatmasker/%s.fasta.cap.contigs.out %s %s >> %s" %(scriptsDir,outDir,line,element,verificationLevel,sys.argv[2]))
